...
public:
  ZedSegmentation() : Node("zed_segmentation") {
    ...
    this->declare_parameter<double>("plane_distance_thresh", 0.1);
    ...
    this->declare_parameter<double>("safe_fill_ratio", 0.70); // 70%
    this->declare_parameter<int>("min_pts_per_cell",   3);    // titik/sel
    this->declare_parameter<double>("normal_eps",      0.02); // kerataan (m), 2 cm
